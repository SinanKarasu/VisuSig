...
public class SSSSettings: NSObject {
    ...
    public enum BufferLength: Int, CaseIterable {
        ...
        public var duration: Double {
            return Double(samplesCount) / SSSSettings.sampleRate
        }
    }
    ...
    /// AudioKit buffer length is set using SSSSettings.bufferLength
    ...
    /// AudioKit recording buffer length is set using SSSSettings.BufferLength
    /// default is .VeryLong for a buffer set to 2 power 10 = 1024 samples (232 ms)
